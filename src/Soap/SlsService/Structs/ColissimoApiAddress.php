 ...
 * @subpackage Structs
 */
class ColissimoApiAddress extends AbstractStructBase
{
    /**
     * The companyName
     ...
     * @uses ColissimoApiAddress::setCompanyName()
     * @uses ColissimoApiAddress::setLastName()
     * @uses ColissimoApiAddress::setFirstName()
     * @uses ColissimoApiAddress::setLine0()
     * @uses ColissimoApiAddress::setLine1()
     * @uses ColissimoApiAddress::setLine2()
     * @uses ColissimoApiAddress::setLine3()
     * @uses ColissimoApiAddress::setCountryCode()
     * @uses ColissimoApiAddress::setCity()
     * @uses ColissimoApiAddress::setZipCode()
     * @uses ColissimoApiAddress::setPhoneNumber()
     * @uses ColissimoApiAddress::setMobileNumber()
     * @uses ColissimoApiAddress::setDoorCode1()
     * @uses ColissimoApiAddress::setDoorCode2()
     * @uses ColissimoApiAddress::setEmail()
     * @uses ColissimoApiAddress::setIntercom()
     * @uses ColissimoApiAddress::setLanguage()
     * @uses ColissimoApiAddress::setStateOrProvinceCode()
     ...
     * @param string $companyName
     * @return \SengentoBV\ColissimoSdk\Soap\SlsService\Structs\ColissimoApiAddress
     */
