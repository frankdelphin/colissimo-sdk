...
/**
 * This class stands for getProductInterRequest Structs
 * @package ColissimoApi
 * @subpackage Structs
 */
class ColissimoApiGetProductInterRequest extends AbstractStructBase
{
    /**
     * The contractNumber
     * @var string|null
     ...
     * @uses ColissimoApiGetProductInterRequest::setContractNumber()
     * @uses ColissimoApiGetProductInterRequest::setPassword()
     * @uses ColissimoApiGetProductInterRequest::setProductCode()
     * @uses ColissimoApiGetProductInterRequest::setInsurance()
     * @uses ColissimoApiGetProductInterRequest::setNonMachinable()
     * @uses ColissimoApiGetProductInterRequest::setReturnReceipt()
     * @uses ColissimoApiGetProductInterRequest::setCountryCode()
     * @uses ColissimoApiGetProductInterRequest::setZipCode()
     * @uses ColissimoApiGetProductInterRequest::setCity()
     ...
     * @param string $contractNumber
     * @return \SengentoBV\ColissimoSdk\Soap\SlsService\Structs\ColissimoApiGetProductInterRequest
     */
