...
/**
 * This class stands for generateLabelRequest Structs
 * @package ColissimoApi
 * @subpackage Structs
 */
class ColissimoApiGenerateLabelRequest extends AbstractStructBase
{
    /**
     * The contractNumber
     * @var string|null
     ...
     * @uses ColissimoApiGenerateLabelRequest::setContractNumber()
     * @uses ColissimoApiGenerateLabelRequest::setPassword()
     * @uses ColissimoApiGenerateLabelRequest::setOutputFormat()
     * @uses ColissimoApiGenerateLabelRequest::setLetter()
     * @uses ColissimoApiGenerateLabelRequest::setFields()
     ...
     * @param string $contractNumber
     * @return \SengentoBV\ColissimoSdk\Soap\SlsService\Structs\ColissimoApiGenerateLabelRequest
     */
