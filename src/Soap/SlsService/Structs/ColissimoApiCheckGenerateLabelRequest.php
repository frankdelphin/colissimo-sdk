...
/**
 * This class stands for checkGenerateLabelRequest Structs
 * @package ColissimoApi
 * @subpackage Structs
 */
class ColissimoApiCheckGenerateLabelRequest extends AbstractStructBase
{
    /**
     * The contractNumber
     * @var string|null
     ...
     * @uses ColissimoApiCheckGenerateLabelRequest::setContractNumber()
     * @uses ColissimoApiCheckGenerateLabelRequest::setPassword()
     * @uses ColissimoApiCheckGenerateLabelRequest::setOutputFormat()
     * @uses ColissimoApiCheckGenerateLabelRequest::setLetter()
     * @uses ColissimoApiCheckGenerateLabelRequest::setFields()
     ...
     * @param string $contractNumber
     * @return \SengentoBV\ColissimoSdk\Soap\SlsService\Structs\ColissimoApiCheckGenerateLabelRequest
     */
