...
/**
 * This class stands for GenerateCN23RequestType Structs
 * @package ColissimoApi
 * @subpackage Structs
 */
class ColissimoApiGenerateCN23RequestType extends AbstractStructBase
{
    /**
     * The contractNumber
     * @var string|null
    ...
    /**
     * Constructor method for GenerateCN23RequestType
     * @uses ColissimoApiGenerateCN23RequestType::setContractNumber()
     * @uses ColissimoApiGenerateCN23RequestType::setPassword()
     * @uses ColissimoApiGenerateCN23RequestType::setLetter()
     * @uses ColissimoApiGenerateCN23RequestType::setFields()
     ...
     * @param string $contractNumber
     * @return \SengentoBV\ColissimoSdk\Soap\SlsService\Structs\ColissimoApiGenerateCN23RequestType
     */
