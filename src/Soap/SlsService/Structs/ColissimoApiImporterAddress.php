...
/**
 * This class stands for importerAddress Structs
 * @package ColissimoApi
 * @subpackage Structs
 */
class ColissimoApiImporterAddress extends AbstractStructBase
{
    /**
     * The companyName
     ...
     * @uses ColissimoApiImporterAddress::setCompanyName()
     * @uses ColissimoApiImporterAddress::setLastName()
     * @uses ColissimoApiImporterAddress::setFirstName()
     * @uses ColissimoApiImporterAddress::setLine0()
     * @uses ColissimoApiImporterAddress::setLine1()
     * @uses ColissimoApiImporterAddress::setLine2()
     * @uses ColissimoApiImporterAddress::setLine3()
     * @uses ColissimoApiImporterAddress::setCountryCode()
     * @uses ColissimoApiImporterAddress::setCity()
     * @uses ColissimoApiImporterAddress::setZipCode()
     * @uses ColissimoApiImporterAddress::setPhoneNumber()
     * @uses ColissimoApiImporterAddress::setMobileNumber()
     * @uses ColissimoApiImporterAddress::setDoorCode1()
     * @uses ColissimoApiImporterAddress::setDoorCode2()
     * @uses ColissimoApiImporterAddress::setEmail()
     * @uses ColissimoApiImporterAddress::setIntercom()
     * @uses ColissimoApiImporterAddress::setLanguage()
     * @uses ColissimoApiImporterAddress::setStateOrProvinceCode()
     ...
     * @param string $companyName
     * @return \SengentoBV\ColissimoSdk\Soap\SlsService\Structs\ColissimoApiImporterAddress
     */
