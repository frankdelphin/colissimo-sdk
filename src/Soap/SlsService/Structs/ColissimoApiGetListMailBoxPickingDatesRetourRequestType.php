...
/**
 * This class stands for GetListMailBoxPickingDatesRetourRequestType Structs
 * @package ColissimoApi
 * @subpackage Structs
 */
class ColissimoApiGetListMailBoxPickingDatesRetourRequestType extends AbstractStructBase
{
    /**
     * The contractNumber
     * @var string|null
     ...
     * @uses ColissimoApiGetListMailBoxPickingDatesRetourRequestType::setContractNumber()
     * @uses ColissimoApiGetListMailBoxPickingDatesRetourRequestType::setPassword()
     * @uses ColissimoApiGetListMailBoxPickingDatesRetourRequestType::setSender()
     ...
     * @param string $contractNumber
     * @return \SengentoBV\ColissimoSdk\Soap\SlsService\Structs\ColissimoApiGetListMailBoxPickingDatesRetourRequestType
     */
